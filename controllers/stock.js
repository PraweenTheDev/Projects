...
module.exports.viewcomplain=(req, res, next)=> {
            ...
            Stock.findById(req.params.item,function(err,info){
                if(!err){
                   res.json(info);
                }else{
  ...
  module.exports.getitemsnumber = (req, res, next) => {
	  
       
            Stock.findOne({ serialnumber: req.params.serialnumber }).then(function(details) {
